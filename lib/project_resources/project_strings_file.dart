...
const String settings_paragraph_intro_string =
    'From the settings page, you can change your password, greeting, app theme color, and give feedback and email the developer about any bugs or app ideas for future updates.';
