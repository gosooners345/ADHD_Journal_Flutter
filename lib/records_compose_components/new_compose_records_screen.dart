...
PageView(
  ...
  child: Column(/*shrinkWrap:true,padding: EdgeInsets.all(10),*/
      children:[
    ...
    /*SizedBox(height: 150,child:*//*Expanded(flex:1,child:*/  Card(
      ...
      elevation: 2.0,margin: const EdgeInsets.all(10),child:Column(/*padding: const EdgeInsets.all(10.0),*/children: [
